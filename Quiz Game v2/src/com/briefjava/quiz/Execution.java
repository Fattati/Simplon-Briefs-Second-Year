...
public class Execution extends Application{
	...
	public void login()
	{
		...
		// les fonts utilis駸 
				...
				Label labelPreom = new Label("Prènom : ");
	...
	public static void niveau1() {
		Quiz quiz1 = new Quiz("JAVA est  un langage", "Compilé et interpreté", "Compilé", "Interpreté", "Compilé et interpreté");
		Quiz quiz2 = new Quiz("Toutes les classes heritent de la classe", "Object", "Main", "Object", "AWT");
		...
		Quiz quiz4 = new Quiz("Est-ce que on peut avoir plusieurs constructeurs pour la m麥e classe", "oui", "oui", "non");
		...
		hearts(2);
		 ...
		 btn_valider.setOnAction(new EventHandler<ActionEvent>() {
				...
				public void handle(ActionEvent e) {
					...
					{
						 showAlertWithHeaderText("Avertissement","Merci de répondre � toute les questions :","Poursuivez");
...
public static void niveau2() {
		...
		Quiz quiz3 = new Quiz("Voici un constructeur de la classe Employee, y-a-t'il un probleme Public void Employe(String n){Nom=n;}", "vrai", "vrai", "faux");
		Quiz quiz4 = new Quiz("Pour specifier que la variable ne pourra plus etre modifiée et doit être initialisée  dès sa déclaration, on la déclare  comme une constante avec le mot r駸erv�", "final", "aucun des choix", "final","const");
		...
		btn_valider =  new Button("Valider");
		 ...
		 btn_valider.setOnAction(new EventHandler<ActionEvent>() {
				...
				public void handle(ActionEvent e) {
					...
					{
						 showAlertWithHeaderText("Avertissement","Merci de repondre � toute les questions :","Poursuivez");
...
public static void niveau3() {
	Quiz quiz1 = new Quiz("calculerSalaire(int) calculerSalaire(int, double)La méthode calculerSalaire est:", "surchargée", "aucun des choix", "surchargée", "redefinie");
	...
	Quiz quiz4 = new Quiz("La déclaration d'une méthode suivante :public void traitement() throws IOExceptionpr馗ise que la méthhode propage une exception contrôlée", "vrai", "vrai", "faux");
	Quiz quiz5 = new Quiz("class Test{public static void main (String[] args) {try {int a =10;System.out.println (\"a = \" + a );int b = 0 / a;System.out.println (\"b = \" + b);}catch(ArithmeticException e){System.out.println (\"diviser par 0!\"); }finally{System.out.println(\"je suis � l’intérieur de finally\");}}}", "a=10 b=0 Je suis � l’intérieur de finally", "aucun des choix", "a=10 b=0 Je suis � l’intérieur de finally", "a=10 b=0 diviser par 0! je suis à l’intérieur de finally");
